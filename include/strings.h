...
extern const u8 gText_BerserkGeneTradeUnsupported[];
...
extern const u8 gText_OddEggFromDaycare[];
...
extern const u8 gText_YouDontHaveEnoughBP[];
...
extern const u8 MatchCall_HNS_Joey_General1[];
extern const u8 MatchCall_HNS_Joey_General2[];
extern const u8 MatchCall_HNS_Joey_General3[];
extern const u8 MatchCall_HNS_Joey_Battle[];
extern const u8 MatchCall_HNS_Wade_General1[];
extern const u8 MatchCall_HNS_Wade_General2[];
extern const u8 MatchCall_HNS_Wade_General3[];
extern const u8 MatchCall_HNS_Wade_FoundItem[];
extern const u8 MatchCall_HNS_Wade_Battle[];
extern const u8 MatchCall_HNS_Ralph_General1[];
extern const u8 MatchCall_HNS_Ralph_General2[];
extern const u8 MatchCall_HNS_Ralph_General3[];
extern const u8 MatchCall_HNS_Ralph_Battle[];
extern const u8 MatchCall_HNS_Liz_General1[];
extern const u8 MatchCall_HNS_Liz_General2[];
extern const u8 MatchCall_HNS_Liz_General3[];
extern const u8 MatchCall_HNS_Liz_Battle[];
extern const u8 MatchCall_HNS_Anthony_General1[];
extern const u8 MatchCall_HNS_Anthony_General2[];
extern const u8 MatchCall_HNS_Anthony_General3[];
extern const u8 MatchCall_HNS_Anthony_Battle[];
extern const u8 MatchCall_HNS_Todd_General1[];
extern const u8 MatchCall_HNS_Todd_General2[];
extern const u8 MatchCall_HNS_Todd_General3[];
extern const u8 MatchCall_HNS_Todd_Battle[];
extern const u8 MatchCall_HNS_Gina_General1[];
extern const u8 MatchCall_HNS_Gina_General2[];
extern const u8 MatchCall_HNS_Gina_General3[];
extern const u8 MatchCall_HNS_Gina_Battle[];
extern const u8 MatchCall_HNS_Irwin_General1[];
extern const u8 MatchCall_HNS_Irwin_General2[];
extern const u8 MatchCall_HNS_Irwin_General3[];
extern const u8 MatchCall_HNS_Irwin_Battle[];
extern const u8 MatchCall_HNS_Arnie_General1[];
extern const u8 MatchCall_HNS_Arnie_General2[];
extern const u8 MatchCall_HNS_Arnie_General3[];
extern const u8 MatchCall_HNS_Arnie_Battle[];
extern const u8 MatchCall_HNS_Alan_General1[];
extern const u8 MatchCall_HNS_Alan_General2[];
extern const u8 MatchCall_HNS_Alan_General3[];
extern const u8 MatchCall_HNS_Alan_FoundItem[];
extern const u8 MatchCall_HNS_Alan_Battle[];
extern const u8 MatchCall_HNS_Dana_General1[];
extern const u8 MatchCall_HNS_Dana_General2[];
extern const u8 MatchCall_HNS_Dana_General3[];
extern const u8 MatchCall_HNS_Dana_FoundItem[];
extern const u8 MatchCall_HNS_Dana_Battle[];
extern const u8 MatchCall_HNS_Chad_General1[];
extern const u8 MatchCall_HNS_Chad_General2[];
extern const u8 MatchCall_HNS_Chad_General3[];
extern const u8 MatchCall_HNS_Chad_Battle[];
extern const u8 MatchCall_HNS_Derek_General1[];
extern const u8 MatchCall_HNS_Derek_General2[];
extern const u8 MatchCall_HNS_Derek_General3[];
extern const u8 MatchCall_HNS_Derek_FoundItem[];
extern const u8 MatchCall_HNS_Derek_Battle[];
extern const u8 MatchCall_HNS_Tully_General1[];
extern const u8 MatchCall_HNS_Tully_General2[];
extern const u8 MatchCall_HNS_Tully_General3[];
extern const u8 MatchCall_HNS_Tully_FoundItem[];
extern const u8 MatchCall_HNS_Tully_Battle[];
extern const u8 MatchCall_HNS_Brent_General1[];
extern const u8 MatchCall_HNS_Brent_General2[];
extern const u8 MatchCall_HNS_Brent_General3[];
extern const u8 MatchCall_HNS_Brent_Battle[];
extern const u8 MatchCall_HNS_Tiffany_General1[];
extern const u8 MatchCall_HNS_Tiffany_General2[];
extern const u8 MatchCall_HNS_Tiffany_General3[];
extern const u8 MatchCall_HNS_Tiffany_Battle[];
extern const u8 MatchCall_HNS_Vance_General1[];
extern const u8 MatchCall_HNS_Vance_General2[];
extern const u8 MatchCall_HNS_Vance_General3[];
extern const u8 MatchCall_HNS_Vance_Battle[];
extern const u8 MatchCall_HNS_Wilton_General1[];
extern const u8 MatchCall_HNS_Wilton_General2[];
extern const u8 MatchCall_HNS_Wilton_General3[];
extern const u8 MatchCall_HNS_Wilton_FoundItem[];
extern const u8 MatchCall_HNS_Wilton_Battle[];
extern const u8 MatchCall_HNS_Kenji_General1[];
...
extern const u8 MatchCall_HNS_Parry_Battle[];
extern const u8 MatchCall_HNS_Erin_General1[];
extern const u8 MatchCall_HNS_Erin_General2[];
extern const u8 MatchCall_HNS_Erin_General3[];
extern const u8 MatchCall_HNS_Erin_Battle[];
extern const u8 MatchCall_HNS_Jack_General1[];
extern const u8 MatchCall_HNS_Jack_General2[];
extern const u8 MatchCall_HNS_Jack_General3[];
extern const u8 MatchCall_HNS_Jack_Battle[];
extern const u8 MatchCall_HNS_Beverly_General1[];
extern const u8 MatchCall_HNS_Beverly_General2[];
extern const u8 MatchCall_HNS_Beverly_General3[];
extern const u8 MatchCall_HNS_Beverly_FoundItem[];
extern const u8 MatchCall_HNS_Beverly_Battle[];
extern const u8 MatchCall_HNS_Huey_General1[];
extern const u8 MatchCall_HNS_Huey_General2[];
extern const u8 MatchCall_HNS_Huey_Battle[];
extern const u8 MatchCall_HNS_Gaven_General1[];
extern const u8 MatchCall_HNS_Gaven_General2[];
extern const u8 MatchCall_HNS_Gaven_General3[];
extern const u8 MatchCall_HNS_Gaven_Battle[];
extern const u8 MatchCall_HNS_Beth_General1[];
extern const u8 MatchCall_HNS_Beth_General2[];
extern const u8 MatchCall_HNS_Beth_General3[];
extern const u8 MatchCall_HNS_Beth_Battle[];
extern const u8 MatchCall_HNS_Jose_General1[];
extern const u8 MatchCall_HNS_Jose_General2[];
extern const u8 MatchCall_HNS_Jose_General3[];
extern const u8 MatchCall_HNS_Jose_FoundItem[];
extern const u8 MatchCall_HNS_Jose_Battle[];
extern const u8 MatchCall_HNS_Reena_General1[];
extern const u8 MatchCall_HNS_Reena_General2[];
extern const u8 MatchCall_HNS_Reena_General3[];
extern const u8 MatchCall_HNS_Reena_Battle[];
extern const u8 MatchCall_HNS_Alex_General1[];
extern const u8 MatchCall_HNS_Alex_General2[];
extern const u8 MatchCall_HNS_Alex_Battle[];
extern const u8 MatchCall_HNS_Riley_General1[];
extern const u8 MatchCall_HNS_Riley_General2[];
extern const u8 MatchCall_HNS_Riley_Battle[];
extern const u8 MatchCall_HNS_Trevor_General1[];
extern const u8 MatchCall_HNS_Trevor_General2[];
extern const u8 MatchCall_HNS_Trevor_Battle[];
extern const u8 MatchCall_HNS_Kyle_General1[];
extern const u8 MatchCall_HNS_Kyle_General2[];
extern const u8 MatchCall_HNS_Kyle_Battle[];
extern const u8 MatchCall_HNS_Carter_General1[];
extern const u8 MatchCall_HNS_Carter_General2[];
extern const u8 MatchCall_HNS_Carter_Battle[];
extern const u8 MatchCall_HNS_Hillary_General1[];
extern const u8 MatchCall_HNS_Hillary_General2[];
extern const u8 MatchCall_HNS_Hillary_Battle[];
...
extern const u8 MatchCall_HNS_Kenny_General1[];
extern const u8 MatchCall_HNS_Kenny_General2[];
extern const u8 MatchCall_HNS_Kenny_Battle[];
extern const u8 MatchCall_HNS_Joel_General1[];
extern const u8 MatchCall_HNS_Joel_General2[];
extern const u8 MatchCall_HNS_Joel_Battle[];
extern const u8 MatchCall_HNS_Charles_General1[];
extern const u8 MatchCall_HNS_Charles_General2[];
extern const u8 MatchCall_HNS_Charles_Battle[];
